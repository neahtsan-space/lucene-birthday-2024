    ...
    <footer>
      <div className="footer">
        <div className='footer-text-container'>      
          <a href={FooterParams.imglink1_URL} target='_blank' className="discord">
          ...
          <a href={FooterParams.imglink2_URL} target='_blank' className="youtube">
            <Image src={FooterParams.imgsrc2} width={40} height={40} className="custom-img" alt="Youtube" /></a>
          <a href={FooterParams.imglink3_URL} target='_blank' className="x_twitter">
            <Image src={FooterParams.imgsrc3} width={40} height={40} className="custom-img" alt="X" /></a>
          <a href={FooterParams.imglink4_URL} target='_blank' className="facebook">
